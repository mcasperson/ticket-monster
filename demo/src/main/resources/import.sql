-- MediaItem 0
insert into MediaItem ( id, mediaType, url) values ( 1, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 1
insert into MediaItem ( id, mediaType, url) values ( 2, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 2
insert into MediaItem ( id, mediaType, url) values ( 3, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 3
insert into MediaItem ( id, mediaType, url) values ( 4, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 4
insert into MediaItem ( id, mediaType, url) values ( 5, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 5
insert into MediaItem ( id, mediaType, url) values ( 6, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 6
insert into MediaItem ( id, mediaType, url) values ( 7, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 7
insert into MediaItem ( id, mediaType, url) values ( 8, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 8
insert into MediaItem ( id, mediaType, url) values ( 9, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 9
insert into MediaItem ( id, mediaType, url) values ( 10, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 10
insert into MediaItem ( id, mediaType, url) values ( 11, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 11
insert into MediaItem ( id, mediaType, url) values ( 12, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 12
insert into MediaItem ( id, mediaType, url) values ( 13, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 13
insert into MediaItem ( id, mediaType, url) values ( 14, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 14
insert into MediaItem ( id, mediaType, url) values ( 15, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 15
insert into MediaItem ( id, mediaType, url) values ( 16, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 16
insert into MediaItem ( id, mediaType, url) values ( 17, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 17
insert into MediaItem ( id, mediaType, url) values ( 18, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 18
insert into MediaItem ( id, mediaType, url) values ( 19, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 19
insert into MediaItem ( id, mediaType, url) values ( 20, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 20
insert into MediaItem ( id, mediaType, url) values ( 21, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 21
insert into MediaItem ( id, mediaType, url) values ( 22, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 22
insert into MediaItem ( id, mediaType, url) values ( 23, 'IMAGE', 'http://placeimg.com/640/128/arch');
-- MediaItem 23
insert into MediaItem ( id, mediaType, url) values ( 24, 'IMAGE', 'http://placeimg.com/640/128/arch');
...
-- Section 1
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 1, 'A', 'Premier platinum reserve',20, 100, 1);
-- Section 2
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 2, 'B', 'Premier gold reserve', 20, 100, 1);
-- Section 3
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 3, 'C', 'Premier silver reserve', 30, 100, 1);
-- section 4
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 4, 'D', 'General', 40, 100, 1);

-- Venue 2
insert into Venue ( id, name, city, country, street, description, mediaitem_id, capacity) values ( 2, 'Sydney Opera House', 'Sydney', 'Australia', 'Bennelong point', 'The Sydney Opera House is a multi-venue performing arts centre in Sydney, New South Wales, Australia' ,3, 15030);

-- Section 5
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 5, 'S1', 'Front left', 50, 50, 2);
-- Section 6
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 6, 'S2', 'Front centre', 50, 50, 2);
-- Section 7
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 7, 'S3', 'Front right',50, 50, 2);
-- Section 8
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 8, 'S4', 'Rear left', 50, 50, 2);
-- Section 9
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 9, 'S5', 'Rear centre', 50, 50, 2);
-- Section 10
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 10, 'S6', 'Rear right', 50, 50, 2);
-- Section 11
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 11, 'S7', 'Balcony', 1, 30, 2);

-- Venue 3
insert into Venue ( id, name, city, country, street, description, mediaitem_id, capacity) values ( 3, 'BMO Field', 'Toronto', 'Canada', '170 Princes Boulevard','BMO Field is a Canadian soccer stadium located in Exhibition Place in the city of Toronto.',5, 30000);

-- Section 12
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 12, 'A', 'Premier platinum reserve',40, 100, 3);
-- Section 13
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 13, 'B', 'Premier gold reserve', 40, 100, 3);
-- Section 14
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 14, 'C', 'Premier silver reserve', 30, 200, 3);
-- Section 15
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 15, 'D', 'General', 80, 200, 3);

-- Venue 4

insert into Venue ( id, name, city, country, street, description, mediaitem_id, capacity) values ( 4, 'Opera Garnier', 'Paris', 'France', '8 Rue Scribe','The Palais Garnier is a 1,979-seat opera house, which was built from 1861 to 1875 for the Paris Opera.', 23, 1972);

-- Section 16
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 16, 'A', 'Center',10, 60, 4);
-- Section 17
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 17, 'B', 'Left', 10, 41, 4);
-- Section 18
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 18, 'C', 'Right', 10, 41, 4);
-- Section 19
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 19, 'D', 'Balcony', 6, 92, 4);

-- Venue 5

insert into Venue ( id, name, city, country, street, description, mediaitem_id, capacity) values ( 5, 'Boston Symphony Hall', 'Boston', 'USA', '301 Massachusetts Avenue','Designed by McKim, Mead and White, it was built in 1900 for the Boston Symphony Orchestra, which continues to make the hall its home. The hall was designated a U.S. National Historic Landmark in 1999.', 24, 1972);

-- Section 20
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 20, 'A', 'Center',10, 60, 5);
-- Section 21
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 21, 'B', 'Left', 10, 41, 5);
-- Section 22
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 22, 'C', 'Right', 10, 41, 5);
-- Section 23
insert into Section ( id, name, description, numberofrows, rowcapacity, venue_id) values ( 23, 'D', 'Balcony', 6, 92, 5);
...
-- Event 1
insert into Event ( id, name,description, mediaitem_id, category_id) values ( 1, 'Rock concert of the decade', 'Get ready to rock your night away with this megaconcert extravaganza from 10 of the biggest rock stars of the 80''s', 1, 1);
-- Event 2
insert into Event ( id, name,description, mediaitem_id, category_id) values ( 2, 'Shane''s Sock Puppets', 'This critically acclaimed masterpiece will take you on an emotional rollercoaster the likes of which you''ve never experienced.', 2, 2);
-- Event 3
insert into Event ( id, name,description, mediaitem_id, category_id) values ( 3, 'Brazil vs. Italy', 'A friendly replay of the famous World Cup final.', 6, 4);
-- Event 4
...
-- Event 16
insert into Event ( id, name,description, mediaitem_id, category_id) values ( 16, 'Tutu Tchai', 'Join your fellow ballet enthusiasts for the National Ballet Company''s presentation of Tutu Tchai, a tribute to Pyotr Tchaikovsky''s and the expressive intensity revealed in his three most famous ballets: The Nutcracker, Swan Lake, and The Sleeping Beauty.', 19, 2);
-- Event 17
...
-- Show 1
insert into Appearance ( id, event_id, venue_id) values ( 1, 1, 1);

-- Performance 1
insert into Performance ( id, show_id, date) values ( 1, 1, '2015-09-21 19:00:00');
...
-- Performance 2
insert into Performance ( id, show_id, date) values ( 2, 1, '2015-09-22 19:00:00');
...
-- Show 2
insert into Appearance ( id, event_id, venue_id) values ( 2, 1, 2);

-- Performance 3
insert into Performance ( id, show_id, date) values ( 3, 2, '2015-09-23 19:30:00');
...
-- Performance #4
insert into Performance ( id, show_id, date) values ( 4, 2, '2015-09-24 19:30:00');
...
-- Show 3
insert into Appearance ( id, event_id, venue_id) values ( 3, 2, 1);

-- Performance 5
insert into Performance ( id, show_id, date) values ( 5, 3, '2015-09-25 17:00:00');
...
-- Performance 6
insert into Performance ( id, show_id, date) values ( 6, 3, '2015-09-25 19:30:00');
...
-- Show 4
insert into Appearance ( id, event_id, venue_id) values ( 4, 2, 2);

-- Performance 7
insert into Performance ( id, show_id, date) values ( 7, 4, '2015-09-27 17:00:00');
...
-- Performance 8
insert into Performance ( id, show_id, date) values ( 8, 4, '2015-09-27 19:30:00');
...
-- show 5
insert into Appearance ( id, event_id, venue_id) values ( 5, 3, 3);

-- Performance 9
insert into Performance ( id, show_id, date) values ( 9, 5, '2015-11-01 21:00:00');
...
-- Show 6
insert into Appearance ( id, event_id, venue_id) values ( 6, 1, 5);

-- Performance 10
insert into Performance ( id, show_id, date) values ( 10, 6, '2015-09-21 19:00:00');
...
-- Performance 11
insert into Performance ( id, show_id, date) values ( 11, 6, '2015-09-22 19:00:00');
